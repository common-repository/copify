 ...
 **/
	public function testCopifyRequestFilterTokenMisMatch() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'setheader'])
			->getMock();
		...
		$this->CopifyWordpress->expects($this->once())
			->method('outputJson')
			->with(array('message' => 'Permission denied: API Key is not set correctly.'));
		$this->CopifyWordpress->expects($this->once())
			->method('setheader')
 ...
 **/
	public function testCopifyCssAndScripts() {
		...
		$this->CopifyWordpress->expects($this->at(0))
			->method('wordpress')
			->with('plugins_url', COPIFY_PLUGIN_DIR.'/js/Copify.js')
		...
		$this->CopifyWordpress->expects($this->at(2))
			->method('wordpress')
			->with('plugins_url', COPIFY_PLUGIN_DIR.'/js/bootstrap-modal.js')
		...
		$this->CopifyWordpress->expects($this->at(4))
			->method('wordpress')
			->with('plugins_url', COPIFY_PLUGIN_DIR.'/js/jquery.validate.js')
		...
		$this->CopifyWordpress->expects($this->at(6))
			->method('wordpress')
			->with('plugins_url', COPIFY_PLUGIN_DIR.'/css/Copify.css')
 ...
 **/
	public function testCopifyRequestAlreadyPublished() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'setheader', 'CopifySetApiClass', 'CopifyJobIdExists'])
			->getMock();
		$mockVal = array(
			'CopifyEmail' => 'foo@bar.com',
			'CopifyApiKey' => '324532452345324',
 ...
 **/
	public function testCopifyRequestMissingCopy() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'setheader', 'CopifySetApiClass', 'CopifyJobIdExists'])
			->getMock();
		$this->CopifyWordpress->Api = $this->createMock('CopifyApi', array('jobsView'), array('foo@bar.com', '324532452345324'));
		$mockVal = array(
			'CopifyEmail' => 'foo@bar.com',
			'CopifyApiKey' => '324532452345324',
			'CopifyLocale' => 'uk',
 ...
 **/
	public function testCopifyRequestNotComplete() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'setheader', 'CopifySetApiClass', 'CopifyJobIdExists'])
			->getMock();
		$this->CopifyWordpress->Api = $this->getMockBuilder(CopifyApi::class)
			->setMethods(['jobsView'])
			->setConstructorArgs(['foo@bar.com', '324532452345324'])
			->getMock();
		$mockVal = array(
			'CopifyEmail' => 'foo@bar.com',
			'CopifyApiKey' => '324532452345324',
 ...
 **/
	public function testCopifyRequestOrderPublished() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'setheader', 'CopifySetApiClass', 'CopifyJobIdExists', 'CopifyAddToPosts'])
			->getMock();
		$this->CopifyWordpress->Api = $this->getMockBuilder(CopifyApi::class)
			->setMethods(['jobsView'])
			->setConstructorArgs(['foo@bar.com', '324532452345324'])
 ...
 **/
	public function testCopifyPostFeedbackEmptyPost() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'setheader', 'CopifySetApiClass', 'CopifyJobIdExists', 'CopifyAddToPosts', 'CopifySetPostThumbnailFromUrl'])
			->getMock();
		$this->CopifyWordpress->Api = $this->getMockBuilder(CopifyApi::class)
			->setMethods(['jobsView'])
			->setConstructorArgs(['foo@bar.com', '324532452345324'])
 ...
 **/
	public function testCopifyPostFeedbackMain() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			...
			->getMock();
		$this->CopifyWordpress->Api = $this->getMockBuilder(CopifyApi::class)
			->setMethods(['jobsView', 'jobFeedback'])
			->setConstructorArgs(['foo@bar.com', '324532452345324'])
			->getMock();
 ...
 **/
	public function testCopifySetPostThumbnailCantLoadUrl() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'setheader', 'CopifySetApiClass', 'CopifyJobIdExists', 'CopifyAddToPosts', '_file_get_contents'])
			->getMock();
		$wp_upload_dir = array(
 ...
 **/
	public function testCopifySetPostThumbnailUploadBitsFails() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'setheader', 'CopifySetApiClass', 'CopifyJobIdExists', 'CopifyAddToPosts', '_file_get_contents', 'unique'])
			->getMock();
		$wp_upload_dir = array(
			'path' => '/Users/robmcvey/Projects/wordpress-3.9/wp-content/uploads/2014/06',
			'url' => 'http://localhost.3dlockers.com/wp-content/uploads/2014/06',
 ...
 **/
	public function testCopifySetPostThumbnailSetThumbFails() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'setheader', 'CopifySetApiClass', 'CopifyJobIdExists', 'CopifyAddToPosts', '_file_get_contents', 'unique', 'setUpdateAttachmentMeta'])
			->getMock();
		$wp_upload_dir = array(
			'path' => '/Users/robmcvey/Projects/wordpress-3.9/wp-content/uploads/2014/06',
			'url' => 'http://localhost.3dlockers.com/wp-content/uploads/2014/06',
 ...
 **/
	public function testUnpublishPost() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'setheader', 'CopifySetApiClass', 'CopifyJobIdExists', 'CopifyAddToPosts', 'CopifySetPostThumbnailFromUrl', 'CopifyBeforeDeletePost'])
			->getMock();
		$this->CopifyWordpress->Api = $this->getMockBuilder(CopifyApi::class)
			->setMethods(['jobsView'])
			->setConstructorArgs(['foo@bar.com', '324532452345324'])
 ...
 **/
	public function testCopifyAddFlickrAttributionNoChange() {
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'setheader', 'CopifySetApiClass', 'CopifyJobIdExists', 'CopifyAddToPosts', 'CopifySetPostThumbnailFromUrl', 'CopifyBeforeDeletePost', '_wp_get_attachment_metadata'])
			->getMock();
 ...
 **/
	public function testCopifyMoveToDraftNotExist() {
		...
		$this->CopifyWordpress = $this->getMockBuilder(CopifyWordpress::class)
			->setMethods(['wordpress', 'outputJson', 'CopifySetApiClass', 'CopifyJobIdExists', 'CopifyAddToPosts'])
			->getMock();
		$this->CopifyWordpress->Api = $this->getMockBuilder(CopifyApi::class)
			->setMethods(['jobsView', 'jobFeedback'])
			->setConstructorArgs(['foo@bar.com', '324532452345324'])
